...
1. 为什么来我们公司面试
    首先，公司的人文价值企业文化，
    其次 与我应聘的岗位是领羊下面的业务开发部门的开发云，主要负责是只能智能数据的建设，这与我个人兴趣与目前职业规划是吻合的
    因此，这是我选择贵公司的原因
2. 做过最成功的事情
...
3. 你的缺点是什么
    - 不要与岗位冲突
    - 回答思路：知道自己缺点之后，如何改正
    整合能力有所欠缺，举个例子：就是我个人在学习当中，很对新技术的感兴趣，去研究新技术解决什么问题，为什么要有它的出现，
    但是碰到真实复杂的问题，凭借单一的知识，往往不能解决，对于此，这也是我个人开始写博客的原因。它设计技术，
    也包括一些其他知识
4. 你的规划是怎么样
b    - 无限制的话，注意层次性
    未来的1-3年，会做精进自己的专业能力，主要是在自己的工作范围内，熟悉它的业务场景，使用到的技术，以及如何提升性能
    3-5年内的话，个人还是会选择做技术，不过这时候就要具备创新性，在工作范围之外，拓宽知识领域边界，
...
6. 你的预期薪资是多少
    ...
    具体回答：（体现自己的能力与专业）
        不要说：具体金额
        我期望有一个符合市场预期的涨幅，就是看贵公司能给到多少，只要有一个合理的涨幅就可以
7. 什么时候可以到岗
    已经离职: 收到offer一周内到岗
    已经提了离职：我需要回去做好解决，最快两周时间，最慢三周
    在职: 一个月的时间
